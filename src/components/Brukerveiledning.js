  ...
  return (
    <div className="brukerveiledning-container">
      <button
        ...
        onClick={() => navigateTo("innstillinger")}
      >
        <FaArrowLeft />
      </button>
      ...
      <div className="section">
        ...
        <p>
          ...
          funksjonene. Bruk filtreringen som befinner seg øverst i høyere hjørne
          for å filtrere dataene etter dine preferanser. Du kan også filtrere de
          lagrede vei-objektene dine inne på{" "}
          <button
            className="lagredeKumlokk-link"
            onClick={() => navigateTo("lagredeKumlokk")}
          >
            Kumlokk i nærheten
          </button>{" "}
          siden. På innstillingssiden finner du ulike innstillinger og
          informasjon du kan lese.
        </p>
      </div>
      ...
      <div className="section">
        ...
        <p>
          ...
          <br />
          <strong>Svar:</strong> Data vil automatisk lagres i det kamera
          oppserverer vegobjekter på skjermen. Du kan finne alle lagrede data
          ved å klikke på lagre-ikonet på bunnnavigasjonen i hovedsiden.
        </p>
        <p>
